 ...
 * position of the users eyes. When using video pass through there is a physical offset between the users eyes and the
 ...
 *
 * @param session Varjo session handle.
 * @param percentage [0.0, 1.0] Linear interpolation of the rendering position between the position of HMD users eyes and
