...
static const varjo_Error varjo_Error_GazeUnsupportedParameter = 105;
...
static const char* varjo_GazeCalibrationParametersValue_CalibrationLegacy = "Legacy";           //!< Legacy (10-dot) gaze calibration.
